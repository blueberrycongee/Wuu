...
- GitHub Releases contain only the macOS desktop GUI. Desktop artifacts are currently unsigned arm64 preview builds because the project does not yet have Apple Developer ID credentials. Do not publish standalone CLI archives.
